...
void setup()
{
  ...
  errorcode = hte.changePeriodicMeasurementTime(5000); // in ms
  if (errorcode != 0)
  {
  ...
  hte.readPeriodicMeasurementTime(measurementTime);
...
void loop()
{
  errorcode = hte.newMeasurementReady(measurementReady);
  if (errorcode != 0)
  {
  }
  else
